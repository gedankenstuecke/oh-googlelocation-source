Thanks for connecting to *Open Humans*. You can now download your *23andMe* data. Below you can find a simple step-by-step guide to get access to the raw data file that we expect as input. If you have already uploaded data you can use the *File List* menu in the menu bar above to see the files you have already in your account.

## How-to: Upload your Google Location History
